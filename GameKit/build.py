...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.obigola.gamekit.js')
	...
	f = os.path.join(cwd,'Classes','ComObigolaGamekitModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.obigola.gamekit.js']
